...
int main(int argc, char *argv[]) {
    ...
    gpio_addr1 = mmap(0, GPIO3_SIZE, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 
                        GPIO3_START_ADDR);
    ...
    printf("Start copying GPIO_98 to GPIO_97\n");
    while(keepgoing) {
    	if(*gpio_datain1& GPIO_98) {
            *gpio_cleardataout_addr1 = GPIO_97;
    	} else {
            *gpio_setdataout_addr1 = GPIO_97;
    	}
        usleep(100000);
    }
